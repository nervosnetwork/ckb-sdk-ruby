...
RSpec.describe CKB::Indexer::Types::CellsCapacity do
  it "to_h" do
	  cells_capacity = CKB::Indexer::Types::CellsCapacity.new(capacity: 1000 * 10**8, block_number: 1000, block_hash: "0x96894ba272c44fdf843604ac82a1aafe67f9c5c2f074335a6d4daebe0d741de6")
    expect do
      cells_capacity.to_h
