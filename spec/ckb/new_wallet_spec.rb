RSpec.describe CKB::NewWallet do
  ...
  it "generate transaction by default scanner" do
    ...
    tx_generator = wallet.generate("ckt1qyqkqqppzt0svxzyedfe7jt0dhxhd9rvt2dskqrjem", CKB::Utils.byte_to_shannon(1000))
  ...
  it "use advance sign" do
    ...
    tx_generator = wallet.generate("ckt1qyqkqqppzt0svxzyedfe7jt0dhxhd9rvt2dskqrjem", CKB::Utils.byte_to_shannon(200))
